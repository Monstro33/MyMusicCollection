...
namespace MyMusicCollection.Migrations
{
    ...
    [Migration("20190311084613_final2")]
            ...
            modelBuilder.Entity("MyMusicCollection.Models.Album", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AlbumImageLocation = "Img/RapCover.jpeg", AlbumInfo = " This collection of some of Rap Music's greatest old school hits. If your looking for a classic hip-hop education or just want to rewind your mind to a place called 'Back In The Day', this album is perfect for you.", AlbumName = "Old School", AlbumReviewContent = "These jams take me on a trip to when life was easy. Back in the day rap really is better than all this new garbage.Lewis --- Memphis" },
                        new { Id = 2, AlbumImageLocation = "Img/ReggaeCover.jpeg", AlbumInfo = "Sooth your mind, body, and soul in this collection of current Reggae hits.", AlbumName = "Relax", AlbumReviewContent = "I work this crazy job but this playlist really gets my mind in the right place. A definate home run for dealing with stress.Teddy --- Tampa" },
